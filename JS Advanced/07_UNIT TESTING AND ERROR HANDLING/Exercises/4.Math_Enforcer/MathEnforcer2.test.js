...
describe("test function MathEnforcer method addFive", function () {
    let num;
    ...
    describe("test function MathEnforcer method subtractTen", function () {
    ...
    describe("test function MathEnforcer method sum", function () {
